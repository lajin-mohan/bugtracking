...
select u.userName as uname,u.employeeID as ueid,u.email as uemail,u.contactNumber1 as contact1,u.contactNumber2 as contact2,d.name as dname from users as u inner join designations as d on u.userID=<cfqueryparam value="#url.userID#" cfsqltype="cf_sql_tinyint"/> and u.designationID=d.designationID;
</cfquery>
