            ...
            <div class="row-fluid">
                <div class="block">
				                    ...
				                    <form action="" method="post">
				                      <div class="controls">                                                                                   <select name="project"> 
                                            <cfquery name="selectProject" datasource="bugTracking">
                                                ...
                                                and projectUsers.userID="#session.userID#" 
                                             </cfquery>
                    ...
                    <cfif isDefined("form.report") and isDefined("form.project")>
                        <cfoutput><cflocation url="pmPersonalReport.cfm?projectID=#form.project#"></cfoutput>
                    </cfif>
                    <div class="block-content collapse in">
                        <div class="span12">
                           ...
                           <cfif isDefined("form.fromDate") and isDefined("form.toDate")>
                               ...
                               <cfelse>
                                <cfinvoke component="components.timeSheet" method="pmDetails" returnVariable="getdetails"></cfinvoke> 
                            </cfif>   
