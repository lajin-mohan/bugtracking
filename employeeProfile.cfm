...
<cfquery name="sample" datasource="#Application.dataSourceName#">
    ...
    where u.userID = <cfqueryparam value="#url.userID#" CFSQLType="CF_SQL_TINYINT"> and
...
<cfquery name="sample2" datasource="#Application.dataSourceName#">
    ...
    r where u.userID = <cfqueryparam value="#url.userID#" CFSQLType="CF_SQL_TINYINT"> and
    u.roleID=r.roleID;
</cfquery>
                ...
                <div class="row-fluid">
                    <div class="navbar navbar-inner block-header">
                        <cfif isdefined('url.projectID')>
                            ...
                            <div class="muted pull-right">
                                <a href="editEmployee.cfm?userID=#url.userID#&projectID=#url.projectID#" 
                                    class="btn btn-default btn-primary" style="display:inline">
                            ...
                            <cfelse>
                                ...
                                <div class="muted pull-right">
                                    <a href="editEmployee.cfm?userID=#url.userID#" 
                                        class="btn btn-default btn-primary" style="display:inline">
                                        <i class="icon-plus-sign"></i>&nbsp;Edit Employee Details
                                    </a>
                                </div>
                    ...
                    <div class="block">
                        <div class="navbar navbar-inner block-header">
                            ...
                            <div class="muted pull-right">
                                <a href="pmSingleEmployeeDetails.cfm?uid=#url.userID#" 
                                    class="btn btn-default btn-primary" style="display:inline">
                            ...
                            <div class="span12">
                                <fieldset>
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="uname" data-required="1" 
                                                ...
                                                value="#sample.firstName&' '&sample.lastName#"/>
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label">Employee ID:</label>
                                        <div class="controls">
                                            <input name="empid" type="text" class="span6 m-wrap" disabled 
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input name="email" type="text" class="span6 m-wrap" disabled 
                                                   value="#sample.email#"/>
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                             <input name="co1" type="text" class="span6 m-wrap" 
                                                    value="#sample.contactNumber1#" disabled/>
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input name="co2" type="text" class="span6 m-wrap" 
                                                    value="#sample.contactNumber2#" disabled/>           
                                        </div>
                                    </div>
                                    <div class="control-group">
