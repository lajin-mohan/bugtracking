                    ...
                    <div class="block-content collapse in">
                        <div class="span12">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <select class="span6 m-wrap" name="category" id="slct">
                                                <cfinvoke component="components.user" method="selectStatus"  returnVariable="getdetails"></cfinvoke> 
                                            ...
                                            <input class="btn btn-mini btn-primary" type="submit" name="search_btn" value="Search"/>
                                            </div>
                                        </div>
                                    </div>
                                </fieldset>
                            ...
                            <cfif isDefined("form.category") and #form.category# GT 0>
                                <cfinvoke component="components.user" method="projectStatus" value="#form.category#" returnVariable="getdetails"></cfinvoke> 
                                <cfelseif !isDefined("form.category") or #form.category# EQ 0>
                                    <cfinvoke component="components.user" method="selectProject" returnVariable="getdetails"></cfinvoke>
                            </cfif>
                            <table class="table table-bordered">
                                ...
                                <cfloop query="getdetails">
                                    <cfoutput>
                                        <tr>
                                            <td><a href="projectProfile.cfm?projectID=#projectID#&flag=1">#projectName#</a></td>
