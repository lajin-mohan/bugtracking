...
<cfif isDefined( "form.subn")>
    <cfquery name="mins" datasource="#Application.dataSourceName#">
        ...
        milestoneName=
        <cfqueryparam value='#form.milestoneName#' cfsqltype="cf_sql_varchar"/>,
        milestoneDescription=
        <cfqueryparam value='#form.milestoneDescription#' cfsqltype="cf_sql_varchar"/>,
        milestoneDate=
        <cfqueryparam value='#form.milestoneDate#' cfsqltype="cf_sql_date"/>,
        milestoneStatus=
                ...
                <div class="span9" id="content">
                    <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">
                                    <h3>Milestone Profile - #m.milestoneName#</h3>
                                </div>
                            </div>
                                            ...
                                            <div class="control-group">
                                                <div class="controls">
                                                    <input type="submit" 
                                                           ...
                                                           value="Save"/>
                                                    <button type="button"
                                                            class="btn btn-default form_btn" 
                                                            id="form_cancel">
                                                        Cancel
                                                    </button>
                                                </div>
