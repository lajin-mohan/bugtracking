...
select timeSheet.dateTime,projects.projectName,timeSheet.description,timeSheet.workingHour,timeSheet.productiveHours,status.name,status.statusID from timeSheet 
    ...
    and timeSheet.userID="#session.userID#" 
    and timeSheet.projectID="#url.pid#"
</cfquery>
