...
<cfif isDefined("form.add")>
    <cfif len(trim(form.formMilestoneName)) and (form.formMilestoneStatus neq "select")>
        <cfquery name="mins" datasource="#Application.dataSourceName#">
            ...
            (projectID, milestoneName, milestoneDescription, milestoneDate,
                        ...
                        <div class="muted pull-left">
                            <form class="form-search" action=" " method="post">
                                <input type="text" class="input-medium search-query"
                                       name="search" placeholder="Search Employee"/>
                                <input class="btn btn-mini btn-primary" type="submit"
                                       name="search_btn" value="GO"/>
                            </form>
                        </div>
                    </div>                    
                            ...
                            <form action=" " method="post">
                                <fieldset>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" class="form-control  span6 m-wrap"
                                                   name="formMilestoneName" placeholder=" Milestone Name" required>
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label">
                                        ...
                                        <div class="controls">
                                            <input type="date" class="form-control   span6 m-wrap"
                                                   name="formMilestoneDate" placeholder=" Date" required>
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label">
                                        ...
                                        <div class="controls">
                                            <textarea class=" span6 m-wrap" name="formMilestoneDescription" 
                                                      placeholder="Milestone Description" required></textarea>	
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label">
                                    ...
                                    <div class="form-actions">
                                        <input type="submit" class="btn btn-primary  hide-element"
...
<cfinclude template="layouts/footer.cfm"/><!---including header--->
