                        ...
                        <cfif isdefined( 'flag')>
                            <div class="navbar navbar-inner block-header">
                                ...
                                <div class="muted pull-right">
                                    ...
                                    <a href="addmilestone.cfm?projectID=#url.projectID#&flag" class="btn btn-default btn-primary" style="display:inline">
                                        <i class="icon-plus-sign"></i>&nbsp;Milestone
                                    </a>&nbsp;&nbsp;&nbsp;&nbsp;
                                    ...
                                    <form action="editProject.cfm?projectID=#url.projectID#" class="form-horizontal" method="post" onsubmit="return checkDate()">
                                        <fieldset>
                                            ...
                                            <div class="control-group">
                                                <label class="control-label">Project Name<span class="required">*</span>
                                                </label>
                                                <div class="controls">
