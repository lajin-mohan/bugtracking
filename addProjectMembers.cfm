...
<cfif isDefined("form.add")>
    ...
    <cfloop from="1" to="#n#" index="i">
        <cfset pid="#A[i]#"/>
        <cfset cuserID="#A[i]#"/>
        <cfquery name="getList" datasource="#Application.dataSourceName#" result="list"><!--to get members mail id-->
        ...
        <cfquery name="getcurrent" datasource="#Application.dataSourceName#" result="current"><!--to get user details-->
        ...
        <cfmail query="getList" from="#session.email#" to="#getList.uemail#" subject="Add_project"><!--to send mail to newly added members-->
                                ...
                                <form action=" " method="post"><!--form to add project members-->
                                    <table class="table table bordered">
                                        ...
                                        <cfloop query="emp"><!--loop to display employees with live projects-->
                                            <tr>
                                                <cfquery name="check" result="c" datasource="#Application.dataSourceName#">
                                                ...
                                                <cfquery name="projectNameValues" datasource="#Application.dataSourceName#">
                                                ...
                                                <cfif !c.recordcount><!--to check if the particular user is already added to project-->
                                                    <td>#emp.userName #</td>
